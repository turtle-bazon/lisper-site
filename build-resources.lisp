...
(defun build-resources ()
  (let* ((base (asdf:system-source-directory :lisper))
         ...
         (favicon-bytes (read-file-to-bytes (merge-pathnames #P"favicon.svg" resources-dir)))
          ...
          (og-image-bytes (read-file-to-bytes (merge-pathnames #P"og-image.png" resources-dir)))
          (og-image-b64 (usb8-array-to-base64-string og-image-bytes))
    ...
    (with-open-file (stream output :direction :output :if-exists :supersede)
      ...
      (format stream "(defparameter *og-image-b64*~%  ~S)~%~%" og-image-b64)
